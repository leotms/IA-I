...
int main(int argc, char **argv ) {
  ...
  if (argc < 4) {
    printf("Missing argument.\nPlease run with ./<problemname>.widastar_manhatan <weigth> <inputfile> <outputfile>\n");
    return 0;
  }
  ...
  while ((read = getline(&line, &len, inputfile)) != -1) {
    ...
    fprintf(outputfile,"dfid, manhatan, %f, %s, ", weigth, domainname(argv[0]));
